*This repository is a mirror of the [component](http://component.io) module [philbooth/trier.js](http://github.com/philbooth/trier.js). It has been modified to work with NPM+Browserify. You can install it using the command `npm install npmcomponent/philbooth-trier.js`. Please do not open issues or send pull requests against this repo. If you have issues with this repo, report it to [npmcomponent](https://github.com/airportyh/npmcomponent).*
# trier.js
